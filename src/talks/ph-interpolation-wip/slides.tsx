// ============================================================================
// Pythagorean–Hodograph Curves — WORK IN PROGRESS
//
// The PARKED SECOND HALF of the ph-interpolation deck. That presentation now ends at slide 9
// (the Möbius pole lab) while its first nine slides are refined; everything from the spatial
// counting slides onward was moved here VERBATIM on 2026-08-24 — slide content, notes, and the
// section headers — so nothing is lost and nothing has to be re-derived when a slide graduates
// back. The figures still live in ../ph-interpolation/ and are imported from there: one source
// of truth, and a figure improved for either deck improves both.
//
// This deck is UNLISTED in the registry — reachable at /talks/ph-interpolation-wip, absent from
// the public index. The slide-number comments below ("7 —", "10 —") are the ORIGINAL deck's
// numbering, kept as provenance rather than renumbered.
// ============================================================================
import type { SlideDefinition } from '../framework/types'
import SpatialCubicFigure from '../ph-interpolation/SpatialCubicFigure'
import QuinticHermiteSpatialFigure from '../ph-interpolation/QuinticHermiteSpatialFigure'
import RmErfFigure from '../ph-interpolation/RmErfFigure'
import RmErfSplineFigure from '../ph-interpolation/RmErfSplineFigure'
import MobiusFigure from '../ph-interpolation/MobiusFigure'
import RationalPHCurveFigure from '../ph-interpolation/RationalPHCurveFigure'
import SexticFivePointFigure from '../ph-interpolation/SexticFivePointFigure'
import RationalPHLoopFigure from '../ph-interpolation/RationalPHLoopFigure'
import RationalPHTwoPoleFigure from '../ph-interpolation/RationalPHTwoPoleFigure'
import IndicatrixFigure from '../ph-interpolation/IndicatrixFigure'
import IndicatrixTwoPoleFigure from '../ph-interpolation/IndicatrixTwoPoleFigure'
import RationalCubicFigure from '../ph-interpolation/RationalCubicFigure'
import IndicatrixCubicFigure from '../ph-interpolation/IndicatrixCubicFigure'
import SharedIndicatrixFigure from '../ph-interpolation/SharedIndicatrixFigure'
import ComplexRationalPHFigure from '../ph-interpolation/ComplexRationalPHFigure'
import CanalSurfaceFigure from '../ph-interpolation/CanalSurfaceFigure'
import ConformalSphereFigure from '../ph-interpolation/ConformalSphereFigure'
import SpherePencilFigure from '../ph-interpolation/SpherePencilFigure'
import ThreeSphereFigure from '../ph-interpolation/ThreeSphereFigure'
...
export const slides: SlideDefinition[] = [
  // ---------------------------------------------------------------------------
  {
    ...
    content: (
      <>
        <h1>Pythagorean&ndash;Hodograph Curves</h1>
        <div className="subtitle">The second half &mdash; rational twice, the gap, what is open</div>
        <div className="author">Eric Demers</div>
        <div className="event note" style={{ marginTop: '2em' }}>
          Work in progress &mdash; parked while the first nine slides are refined
        </div>
      </>
    ),
    notes:
      'THIS DECK IS A PARKING LOT, not a presentation. The main deck now ends at the Moebius pole '
      + 'lab; everything after it was moved here unchanged so it is not lost while the first nine '
      + 'slides are improved. Slides graduate back one at a time, with their notes.',
  },
  // ---------------------------------------------------------------------------
