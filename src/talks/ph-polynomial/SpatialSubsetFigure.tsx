    ...
    <Figure3D
      ...
      caption={mode === 'free' ? (
        ...
        <>
          ...
          there are {m} dial{m > 1 ? 's' : ''} — at every grip, since the count cannot see which
          points you hold. What the grip decides is the shape.{' '}
          {bounded
            ? kind === 'angles'
              ...
              : kind === 'tour'
                ...
                : 'Both ends and one point out of each consecutive pair — the family stays bounded, and the plane gets all 2^m of its interpolants on exactly these grips.'
            : 'This grip is not one of those, so the family runs away — and the planar problem loses branches on exactly the same grips.'}{' '}
