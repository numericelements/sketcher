...
// ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    notes:
      ...
      + 'WHERE THE ROAD ENDS, and it is a real edge rather than a stall. It runs further one way than the other; going the short way rho_4 falls from 0.62 toward 0.29, and a sphere radius reaching zero is a POINT-sphere -- a boundary of the family. Drawing the road shows that as an end you can see, which is better than a message. '
